...
<head>
  ...
  <?php print $head; ?>
	 ...
	 <meta property="fb:admins" content="hlozada,wilfredo.manrique" />
  <?php print $styles; ?>
  <?php print $scripts; ?>
</head>
<?php
if ($_SERVER['SERVER_NAME'] == "m.avn.info.ve") {
	$classes_mobile = "section-mobile";
}
?>
<?php
global $base_url;
...
?>
<body class="<?php print $classes; print " ".$classes_mobile; ?>">

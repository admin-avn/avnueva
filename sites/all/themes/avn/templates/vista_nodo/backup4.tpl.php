...
if(empty($image)) {
	...
	if($height > 3*$width/4) {
		$image = theme('imagecache', 'nodo-imagen-principal-vertical', $image);
	} else {
		$image = theme('imagecache', 'nodo-imagen-principal', $image);
	}
}
...
<div class="nodo-encabezado">
	...
	<div class="cajon-video">
		<div class="video">
			<?php print video($fields['field_video_fid']->content, arg(2), 612, 384, $fields['field_imagen_fid']->content); ?>
		</div>
	</div>
	<?php
